        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="title flxTitle">
                    <h2 class="withSubTitle">Jochem van Amsterdam <a href="{{route('manager.settings.organisation')}}" style="text-decoration: underline;">Organisatie</a></a></h2>
                    <div class="r2btn">
            ...
            <div class="col-lg-4">
                <div class="lktFrmDts">
                    <form action="#" class="lktAFrm notEditing">
                        ...
                        <a href="#" class="mdlLink text-center">Reset Authenticator</a>
                    </form>
                </div>
            </div>
            <div class="col-lg-8">
